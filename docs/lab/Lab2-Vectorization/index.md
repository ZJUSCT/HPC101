...
!!! info "OJ 评分指标"
    ...
    | --- | ---: | ---: | ---: | ---: | ---: |
    | 基本任务 | 60 分 | 14.0 | 8.0 | 50.0 | 55.0 |
    | 基本任务 | 100 分 | 20.0 | 15.0 | 100.0 | 120.0 |
    | 基本任务 | 120 分 | 26.0 | 19.0 | 150.0 | 275.0 |
    | Bonus 任务 | 60 分 | 9.0 | 10.0 | 55.0 | 14.0 |
    | Bonus 任务 | 100 分 | 12.0 | 14.0 | 84.0 | 20.0 |
    | Bonus 任务 | 120 分 | 16.0 | 18.5 | 114.5 | 27.0 |
    ...
    u_2=\frac{p-p_{100}}{p_{120}-p_{100}}.
    $$

!!! danger "提交方式"

    请在课程平台上按照要求提交目录结构。OJ 评测与作业提交使用完全相同的目录结构。  
    对于 x86 和 riscv 平台代码，请使用预编译条件选择编译，写到同一个 `student/moe_opt.cpp` 中进行提交.
