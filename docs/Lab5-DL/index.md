...
新建一个 python 版本为 3.12 的空环境，并使用 `pip install -i https://mirrors.zju.edu.cn/pypi/web/simple --extra-index-url https://download.pytorch.org/whl/cu121 -r requirements.txt` 安装所必须的包 
