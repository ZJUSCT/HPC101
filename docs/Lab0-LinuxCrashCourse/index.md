...
- Read this [presentation](https://slides.tonycrane.cc/PracticalSkillsTutorial/2023-fall-ckc/lec1/) or watch this [video](https://www.bilibili.com/video/BV1ry4y1A7qo/).
...
!!! question "Task 1.1: Download and verify the latest **textonly** version of Debian ISO image from [ZJU Mirrors](https://mirrors.zju.edu.cn/debian-cd/)"
    ...
    === "Step 1"
        ...
        We need you to download the **textonly** version. Don't know how to find correct download link from the above webpage? Read this guide: [Your guide to Debian iso downloads - GitHub](https://github.com/slowpeek/debian-iso-guide).
...
!!! question "Task 1.2: Download and install VMware Hypervisor"
    ...
    Watch this video to learn how to download and install VMware Workstation Pro: [VMware Workstation Pro is Now FREE (How to get it) - Youtube](https://www.youtube.com/watch?v=66qMLGCGP5s)
...
!!! question "Task 1.3: Create a new virtual machine and install Debian"
    ...
    Here we use VMware Workstation Pro for demonstration.
...
Watch [Linux File System Explained! - Youtube](https://www.youtube.com/watch?v=bbmWOjuFmgA)
...
- [IP、MAC、DHCP 与 ARP - Bilibili](https://www.bilibili.com/video/BV1CQ4y1d728)
- [IP 与 NAT - Bilibili](https://www.bilibili.com/video/BV1DD4y127r4)

### Network in Virtual Machines

Watch this video to understand network in the virtual machines: [虚拟机网络模式 - Bilibili](https://www.bilibili.com/video/BV11M4y1J7zP).
...
??? info "Asymmetric Encryption"
    ...
    For more information, watch this video: [Asymmetric Encryption - Simply explained](https://www.youtube.com/watch?v=AQDCe585Lnc)
...
- Users and Groups: [Linux Crash Course - Managing Users](https://www.youtube.com/watch?v=19WOD84JFxA)
- Permissions: [Linux File Permissions in 5 Minutes | MUST Know!](https://www.youtube.com/watch?v=LnKoncbQBsM)
...
!!! question "Task 4.1: Go to [ZJU Git](https://git.zju.edu.cn) and register an account."

### Configure Public Key

!!! question "Task 4.2: Generate an SSH key and add it to your ZJU Git account."

    === "Step 1"

        Follow this guide to generate an SSH key: [Generating a new SSH key and adding it to the ssh-agent - GitHub](https://docs.github.com/en/github/authenticating-to-github/generating-a-new-ssh-key-and-adding-it-to-the-ssh-agent)
