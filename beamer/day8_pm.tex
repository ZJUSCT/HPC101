...
\input{day8_pm/sections/1_introduction}
\input{day8_pm/sections/2_cpp_intro}
\input{day8_pm/sections/3_thread}
\input{day8_pm/sections/4_mutex}
\input{day8_pm/sections/5_condition_variable}
\input{day8_pm/sections/6_parallel_algorithm}
%\input{day8_pm/sections/7_summary}
%
